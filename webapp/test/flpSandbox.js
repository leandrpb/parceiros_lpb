		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Parceiros Freestyle",
									"targetURL": "#zappfreestylelpbparceiroslpb-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zappfreestylelpbparceiroslpb-display": {
								"semanticObject": "zappfreestylelpbparceiroslpb",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zappfreestylelpb.parceiroslpb",
									"url": sap.ui.require.toUrl("zappfreestylelpb/parceiroslpb")
								}
							}
						}
					}
